...
class AdminController extends Controller
{
    ...
    {
        $cities = DB::table('canadacities')
        ->where('province',$_GET['province'])->get();
    ...
    {
        $input=$request->all();
        $insert=['company_id'=>$input['company_id'],'name'=>$input['district_name']];
    ...
    //     exit;
        ...
        $raw_query= get_comma_sepearted_id_cities();
