...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="../images/favicon.ico">
     ...
     <title>{{ config('app.name', 'Laravel') }} - District Manager Login</title>
            ...
            <div class="modal-dialog mt-150">
                <div class="modal-content" style="border-radius: 5px;">
                    <div class="modal-header">
                        <h5 class="modal-title">District Manager Login</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><a href="{{url('/')}}"></a></button>
                    </div>
                    @if (count($errors) > 0)
                ...
                <div class="login-input">
                    ...
                    <div class="p-16">
                                <form action="{{ route('owner.signin')}}" method="post">
                                    @csrf
                                      <input type="hidden" class="form-control ps-15 bg-transparent" placeholder="role" name="role" value="Dmanager">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text bg-transparent"><i class="ti-user"></i></span>
                                            <input type="text" class="form-control ps-15 bg-transparent" placeholder="Username" name="email">
