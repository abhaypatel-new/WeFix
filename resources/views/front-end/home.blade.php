    ...
    <div class="homediv">
        <div  style="margin-bottom: 180px;" class="btn-div text-center">
            ...
            <button type="button" class="buttontwo"><a href="#" style="color: #fff;">Contact Us</a></button>
        </div>
    </div>
    <div>
        <div>
            <div style="margin-top: -230px;" class="container">
                ...
                <div class="align-div flex-wrap">
                    <div class="single-feature text-center proposal-hover" style="margin-right: 20px;">
                    ...
                    <div class="single-feature text-center proposal-hover">
                        <div class="feature-icon">
                            <div class="img-div">
                    ...
                    <div class="single-feature text-center proposal-hover" style="margin-left: 20px;">
                        <div class="feature-icon">
                            <div class="img-div">
    ...
    <div class="about-img">
        <img src="{{ asset('images')}}/image/WE Are.jpg" alt="" width="527px" height="466px" class="proposal-hover">
    ...
    <div class="we-are-text-res">
        <h1>WE ARE MOST POPULAR <br>REPAIR WE FIX </h1>
        <p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
            <br> impedit quo minus id quod maxime placeat facere possimus, omnis
            <br> voluptas assumenda est, omnis dolor repellendus,
        </p>
        <div>
            <div class="we-are-main-01-res">
                <div class="we-are-main-res">
                    <h2 class="we-are-text-h2-res">
                        80
                    </h2>
                    <h5 class="we-are-text-h5-res">
                        Member
                        <br> Professional
                    </h5>
                </div>
        ...
        <button class="about-button-res">Learn More</button>
    </div>
    <div class="about-main">
        <div class="module-border-wrap">
            <div class="body-about">
    ...
    <section class="swiper-sec">
        ...
        <div class="swiper mySwiper container">
            <div class="swiper-wrapper content" id="our-vendors">
            </div>
        </div>
...
<div class="swiper mySwiper container">
    <div class="swiper-wrapper content">
        ...
        <div class="swiper-slide swiper-res">
            <div class="blog-img">
                <h5>13 Nov</h5>
    ...
    for (let r of data.data) {
        let img = r.thumbnail_image == null?"https://miro.medium.com/max/600/0*jGmQzOLaEobiNklD":r.thumbnail_image;
         tab += `  <div class="swiper-slide  product-swiper proposal-hover">
                <div class="Product-card" style="height: 290px !important;"><a href="./product-details?id=${r.id}" style="text-decoration: none;">
...
function show_vendor_list(data) {
    ...
    for (let r of data.data) {
        let img = r.image == null?"{{ asset('images')}}/image/Mary Walden.jpg":r.image;
         tab += `     <div class="swiper-slide swipe-res proposal-hover">
                    <div class="tema-card">
                    <img src="${img}" alt="" width="220px" height="260px">
