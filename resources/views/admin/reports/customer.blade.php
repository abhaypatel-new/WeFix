					  ...
					  <!-- /.form-group -->
						...
						<div class="col-md-4">
						            <select class="form-select" data-placeholder="Choose a Vendor" tabindex="1">
											<option value="Category 1">Customer 1</option>
											<option value="Category 2">Customer 2</option>
											<option value="Category 3">Customer 3</option>
											<option value="Category 4">Customer 4</option>
										</select>
						</div>
