            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="me-auto">
                            <h3 class="page-title">Edit Owner</h3>
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="box">
                                ...
                                <form class="form" method="post"
                                    action="{{ route('customer.update',encrypt($customer->id))}}">
                                    @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <?php $selected_cat=explode(',', $customer->category); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" placeholder="About Owner"
                                                name="desc">{{$customer->desc}}</textarea>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
