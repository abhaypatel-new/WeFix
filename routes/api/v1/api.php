 ...
 */
   ...
   //Route::get('view_custom', 'Customerproduct@view_custom')->name('view_custom');
   Route::get('customer_products', 'Customerproduct@customer_products')->name('customer_products');
//echo "ghfdg";die;
// Route::post('customerstore','api\Customerproduct@customerstores')->name('customerstore');
 ...
 Route::post('view_custom', [Customerproduct::class, 'view_custom']);
 Route::post('edit_custom_product', [Customerproduct::class, 'edit_custom_product']);
 Route::post('delete_product', [Customerproduct::class, 'delete_product']);
